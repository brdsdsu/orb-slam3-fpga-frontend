...
################################################################
# This is a generated script based on design: HW_Acc
#
...
# source HW_Acc_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# orb_feature_top, axi_axcache_override, orb_feature_top, axi_axcache_override
...
proc create_root_design { parentCell } {
  ...
  # Create instance: orb_feature_top_0, and set properties
  set block_name orb_feature_top
  set block_cell_name orb_feature_top_0
  if { [catch {set orb_feature_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $orb_feature_top_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.G_SCORE_TYPE {0} $orb_feature_top_0
...
\
  ...
  set_property CONFIG.ADVANCED_PROPERTIES { __view__ { }} $smartconnect_0
  ...
  # Create instance: axi_axcache_override_0, and set properties
  set block_name axi_axcache_override
  set block_cell_name axi_axcache_override_0
  if { [catch {set axi_axcache_override_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_axcache_override_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: orb_feature_top_1, and set properties
  set block_name orb_feature_top
  set block_cell_name orb_feature_top_1
  if { [catch {set orb_feature_top_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $orb_feature_top_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.G_SCORE_TYPE {0} $orb_feature_top_1
  ...
  set_property CONFIG.ADVANCED_PROPERTIES { __view__ { }} $smartconnect_1


  # Create instance: axi_axcache_override_1, and set properties
  set block_name axi_axcache_override
  set block_cell_name axi_axcache_override_1
  if { [catch {set axi_axcache_override_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axi_axcache_override_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create interface connections
  connect_bd_intf_net -intf_net axi_axcache_override_0_m_axi [get_bd_intf_pins axi_axcache_override_0/m_axi] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
  connect_bd_intf_net -intf_net axi_axcache_override_1_m_axi [get_bd_intf_pins axi_axcache_override_1/m_axi] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC1_FPD]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axis_register_slice_0/S_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S] [get_bd_intf_pins axis_register_slice_2/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_smc1_M00_AXI [get_bd_intf_pins axi_smc1/M00_AXI] [get_bd_intf_pins axi_dma_1/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_smc1_M01_AXI [get_bd_intf_pins axi_smc1/M01_AXI] [get_bd_intf_pins orb_feature_top_1/s_axi]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins orb_feature_top_0/s_axi]
  connect_bd_intf_net -intf_net axis_register_slice_0_M_AXIS [get_bd_intf_pins axis_register_slice_0/M_AXIS] [get_bd_intf_pins orb_feature_top_0/s_axis]
  connect_bd_intf_net -intf_net axis_register_slice_1_M_AXIS [get_bd_intf_pins axis_register_slice_1/M_AXIS] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axis_register_slice_2_M_AXIS [get_bd_intf_pins axis_register_slice_2/M_AXIS] [get_bd_intf_pins orb_feature_top_1/s_axis]
  connect_bd_intf_net -intf_net axis_register_slice_3_M_AXIS [get_bd_intf_pins axis_register_slice_3/M_AXIS] [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net orb_feature_top_0_m_axis [get_bd_intf_pins orb_feature_top_0/m_axis] [get_bd_intf_pins axis_register_slice_1/S_AXIS]
  connect_bd_intf_net -intf_net orb_feature_top_1_m_axis [get_bd_intf_pins orb_feature_top_1/m_axis] [get_bd_intf_pins axis_register_slice_3/S_AXIS]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins axi_axcache_override_0/s_axi]
  connect_bd_intf_net -intf_net smartconnect_1_M00_AXI [get_bd_intf_pins smartconnect_1/M00_AXI] [get_bd_intf_pins axi_axcache_override_1/s_axi]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM1_FPD [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM1_FPD] [get_bd_intf_pins axi_smc1/S01_AXI]
  ...
  [get_bd_pins orb_feature_top_0/aresetn] \
  [get_bd_pins axi_smc1/aresetn] \
  [get_bd_pins axis_register_slice_2/aresetn] \
  [get_bd_pins orb_feature_top_1/aresetn] \
  ...
  [get_bd_pins axi_axcache_override_0/aclk] \
  [get_bd_pins orb_feature_top_0/aclk] \
  [get_bd_pins axi_smc1/aclk] \
  [get_bd_pins axis_register_slice_2/aclk] \
  [get_bd_pins orb_feature_top_1/aclk] \
  ...
  [get_bd_pins axi_axcache_override_1/aclk] \
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs orb_feature_top_0/s_axi/reg0] -force
  assign_bd_address -offset 0xB0010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs orb_feature_top_1/s_axi/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs axi_axcache_override_0/s_axi/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_axcache_override_0/s_axi/reg0] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces axi_axcache_override_0/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_axcache_override_0/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_dma_1/Data_MM2S] [get_bd_addr_segs axi_axcache_override_1/s_axi/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces axi_dma_1/Data_S2MM] [get_bd_addr_segs axi_axcache_override_1/s_axi/reg0] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces axi_axcache_override_1/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_axcache_override_1/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_DDR_LOW] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_axcache_override_0/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_LPS_OCM]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_axcache_override_0/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_QSPI]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_axcache_override_1/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_LPS_OCM]
  exclude_bd_addr_seg -target_address_space [get_bd_addr_spaces axi_axcache_override_1/m_axi] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP1/HPC1_QSPI]
